...
const Sort = () => {
    ...
    const{grid_view,Setgridview,Setlistview,filterproducts,Sorting}=useCustomeFilterContext();
    ...
    return (
        <Wrapper className="sort-section">
            ...
            {/* <div className="product-data">{`${filterproducts.length} Product Available`}</div> */}
            <div className="product-data">{`${filterproducts.length} Product Available`}</div>
